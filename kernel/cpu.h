...
#define RDRAND       0x40000000  //集成随机数发生器
...
const struct extened_set_struct extened_set = {
    .set_Name = {"SSE3","PCLMULQDQ","DTES64","MONITOR","DS_CPL","VMX","SMX","EST","TM2","SSSE3","CNXT_ID","SDBG","FMA","CX16","XTPR","PDCM","PCID","DCA","SSE4_1","SSE4_2","X2APIC","MOVBE","POPCNT","TSC_DEADLINE","AES","XSAVE","OSXSAVE","AVX","F16C","RDRAND","HYPERVISOR"},
    .set_Value = {SSE3,PCLMULQDQ,DTES64,MONITOR,DS_CPL,VMX,SMX,EST,TM2,SSSE3,CNXT_ID,SDBG,FMA,CX16,XTPR,PDCM,PCID,DCA,SSE4_1,SSE4_2,X2APIC,MOVBE,POPCNT,TSC_DEADLINE,AES,XSAVE,OSXSAVE,AVX,F16C,RDRAND,HYPERVISOR},
};
